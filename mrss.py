...
def delete_and_create_new_layout():
    # Loop through each item in teams_videos and upload the video
    for item in replacement_array:
        try:
            ...
            if item['layout_id'] is not None:
               ...
               delete_url = f"https://cdn2.barvanna.com/api/layout/{layoutid}"
               delete_response = requests.delete(delete_url, headers=layout_headers)
